  ...
  return (
    <div className="flex flex-col min-h-screen font-sans bg-background">
      ...
      <main className="flex-1 w-full px-4 md:px-8 lg:px-12">
        ...
        {/* Layout Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 mb-20 relative gap-12 lg:gap-0">

          {/* Side Info (Left) */}
          <div className="lg:col-span-4 flex flex-col gap-12 lg:border-r border-border lg:pr-12 pb-12">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                {[
                  ...
                  <div
                    key={color.hex}
                    className={`w-24 h-32 md:w-32 md:h-40 rounded-xl shadow-sm relative flex items-end p-4 ${color.textClass}`}
                    style={{ backgroundColor: color.hex }}
                  >
                    <span className="font-bold text-xs tracking-wide">{color.hex.toLowerCase()}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  <Badge key={tech.name} variant="outline" className="rounded-full text-sm font-bold border-black/20 text-black px-6 py-4 bg-transparent hover:bg-secondary transition-colors flex items-center gap-2">
            ...
            <div className="space-y-12">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-border pb-2 gap-4">
                ...
                <div className="pb-2">
                  <Dialog>
                    <DialogTrigger render={
                      <Button variant="outline" className="rounded-full font-bold text-sm border-border hover:border-black h-10 px-6">
                        + Update
                      </Button>
                    } />
                    <DialogContent className="bg-white border-border rounded-2xl sm:max-w-md p-6">
              ...
              <div className="space-y-16">
                  ...
                  <div className="grid grid-cols-1 xl:grid-cols-2 gap-12">
                    ...
                    <div>
                      ...
                      <div className="text-muted-foreground leading-relaxed text-base max-w-4xl space-y-4">
